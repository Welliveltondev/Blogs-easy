  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 boder border-primary/40 bg-primary/10 rounded-full text-sm'>
      ...
      <div className='text-center'>
        {
        input && <button onClick={onClear} className='border font-light text-xs py-1 rounded-sm shadow-sm cursor-pointer'>Clear Search</button>
        }
        </div>

      <img src={assets.gradientBackground} className='absolute -top-50 opacity-50 -z-1' alt="" />
    </div>
  )
}
